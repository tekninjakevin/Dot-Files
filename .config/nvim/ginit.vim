...
"---Templets
    ...
    autocmd BufNewFile *.html or /home/kevin/Templates/html.tpl
...
let g:startify_lists=[
	    ...
	    \ ]
let g:startify_commands = [ 'VimwikiIndex', 'VimDaryIndex', 'Notes', 'MRU', 'NERDTree', 'Explore', 'syntax on' ]
let g:startify_bookmarks = ['~/.zshrc', '~/.aliasrc', '~/.i3/config', '~/.config/nvim/init.vim', '~/.remind','~/.config/ranger/rc.conf','~/.Homepage/index.html','~/Templates/Template.html','~/Templates/Templates.cpp','~/Templates/Template.py','~/.config/ranger/rifle.conf']
""""""""""""
"Airline   "
""""""""""""
"main settings
